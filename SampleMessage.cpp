...
SampleMessage::SampleMessage(const std::vector<uint8_t> &raw)
{
    ...
    this->values["Flow temp. [°C]"] = FormatNumber(unpack.f4, 100, -25, 150, "Open", "Closed");
    this->values["Return temp. [°C]"] = FormatNumber(unpack.f5, 100, -25, 150, "Open", "Closed");
    this->values["DHW temp. [°C]"] = FormatNumber(unpack.f6, 100, -25, 150, "Open", "Closed");
    this->values["Outside temp. [°C]"] = FormatNumber(unpack.f8, 100, -25, 150, "Open", "Closed");
    this->values["Calorifier temp. [°C]"] = FormatNumber(unpack.f7, 100, -25, 150, "Open", "Closed");
    this->values["Boiler Control temp. [°C]"] = FormatNumber(unpack.f14, 100, -25, 150, "Open", "Closed");
    this->values["Room temp. [°C]"] = FormatNumber(unpack.f12, 100, -25, 150, "Open", "Closed");
    this->values["CH Setpoint [°C]"] = FormatNumber(unpack.f10, 100, 0, 100, "Open", "Closed");
    this->values["DHW Setpoint [°C]"] = FormatNumber(unpack.f11, 100, 0, 100, "Open", "Closed");
    this->values["Room temp setpoint [°C]"] = FormatNumber(unpack.f13, 100, 0, 100, "Open", "Closed");
    ...
    this->values["Ionisation current [uA]"] = FormatNumber(unpack.f17, 10, 0, 10, "0", "10");
    this->values["Internal setpoint [°C]"] = FormatNumber(unpack.f9, 100, 0, 100, "Open", "Closed");
